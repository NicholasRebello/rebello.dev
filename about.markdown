...
<script>
    ...
    lineData: [
        { value:'🆁🅴🅱🅴🅻🅻🅾.🅳🅴🆅'},
        { type: 'input', prompt: '~test', value: 'sudo apt install rebello.details' },
        { type: 'input', prompt:'Enter Password for Sudo:', typeDelay: 100, value: '************************'},
        ...
        { prompt:'>', color: var(--red), value: 'About Nicholas Rebello'},
