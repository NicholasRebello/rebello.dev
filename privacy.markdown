...
permalink: /privacy/
---
My website address is: https://rebello.dev

For more details about this privacy policy please email: <a class="u-email" href="mailto:{{ site.author.email }}">{{ site.author.email }}blog.contact@rebz.anonaddy.com</a>

This privacy policy sets out how I use and protect your Personally Identifiable Information when you use this website.

This Privacy Policy was put in place 04-Dec-2021 and is effective immediately. Last updated 25-Dec-2021
...
## Staticman Comments
I use [Staticman](https://staticman.net/docs/) to allow my static site to accept dynamic content submissions (your comments). This is also forked, and hosted on Heroku. I currently do not have Staticman configured to use any sort of spam filtering, such as reCAPTCHA. However in the future, if support for [hCaptcha](https://www.hcaptcha.com/) becomes available, I may consider using that.
